...
\clearpage
% Manually add Daftar Pustaka to TOC if it doesn't appear automatically
\phantomsection % Creates a target for the hyperlink
\addcontentsline{toc}{chapter}{\bibname} % Adds "DAFTAR PUSTAKA" to the TOC
\nocite{*}
\bibliography{BAB_SKRIPSI/BAB8_DAFTAR_PUSTAKA/1_DAFTAR_PUSTAKA}
%-----------------------------------------------------------------
